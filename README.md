...
> 🚀 **เดโมปัจจุบัน (`site/`, v1.3):** แกะคอร์ดจากไฟล์เสียง *ในเบราว์เซอร์ 100%* — DSP เอนจินอัปเกรด (ชดเชยจูนเพี้ยน, bass chroma, คอร์ด 7th, Viterbi รู้คีย์ — เทสต์วัดผลใน `tools/test-dsp.cjs`) + **ถอดเนื้อร้องไทย/อังกฤษด้วย Whisper ในเครื่อง (Beta)** แล้วผสานคอร์ดวางเหนือเนื้อร้องอัตโนมัติ โดยไฟล์เสียงไม่ถูกอัปโหลดขึ้นเซิร์ฟเวอร์

...
(function () {
  const DICT = {
    th: {
      ...
      'job.cancel': 'ยกเลิก',
      'job.stage.ingest': 'รับไฟล์เสียง',
      'job.stage.separate': 'แยกเสียงเครื่องดนตรี',
      'job.stage.chords': 'วิเคราะห์คอร์ดและจังหวะ',
      'job.stage.lyrics': 'ถอดเนื้อเพลง',
      'job.stage.tabs': 'สร้างแท็บกีตาร์',
      'job.stage.assemble': 'ประกอบเป็นแผ่นคอร์ด',
      'job.done': 'แกะเพลงเสร็จแล้ว!',
      'job.demoNote': 'โหมดสาธิต — เชื่อมต่อ AI จริงในเฟสถัดไป (ดูเอกสาร docs/02)',
    ...
    en: {
      ...
      'job.cancel': 'Cancel',
      'job.stage.ingest': 'Fetching audio',
      'job.stage.separate': 'Separating instruments',
      'job.stage.chords': 'Analyzing chords & beat',
      'job.stage.lyrics': 'Transcribing lyrics',
      'job.stage.tabs': 'Generating guitar tabs',
      'job.stage.assemble': 'Assembling chord sheet',
      'job.done': 'Transcription complete!',
      'job.demoNote': 'Demo mode — real AI connects in the next phase (see docs/02)',

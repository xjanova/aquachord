...
│                  · dsp (เอนจินคอร์ด + แยกเสียงร้อง — เทสต์ใน ../tools/test-dsp.cjs)
...
## ฟีเจอร์หน้าเว็บ
**แกะคอร์ดจากไฟล์เสียงจริงในเครื่อง 100%** (DSP: ชดเชยจูนเพี้ยน · แยกเบสช่วยหา root · คอร์ด maj/min/7/m7/maj7 · Viterbi รู้คีย์ 2 รอบ) · **ถอดเนื้อร้องไทย/อังกฤษด้วย Whisper ในเบราว์เซอร์ (Beta — เปิดไว้เป็นค่าเริ่มต้น ปิดได้ ไม่อัปโหลดเสียง)** โดย**แยกเสียงร้องออกจากดนตรีก่อน** (center extraction) แล้วจัดคอร์ดวางเหนือเนื้อร้องตามจังหวะ · แสดง ChordPro + เปลี่ยนคีย์/คาโป้ · เล่นเสียงคอร์ด/โน้ตด้วย Web Audio (Karplus-Strong, ออฟไลน์ได้) · คลังเพลง (localStorage) · แก้ไข/นำเข้า-ส่งออก · **สองภาษา ไทย/อังกฤษ** · **โหมดมืด (ฟองอากาศม่วงเรืองแสง)** · ติดตั้งเป็นแอป (PWA)
